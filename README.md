...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mohammad-kureshi/)
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:mohd.kureshi04@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-%23121011.svg?logo=github&logoColor=white)](https://github.com/AIAnalyticsKureshi)
...
### 🚛 Multimodal Freight Decision Intelligence
> Power BI decision-support dashboard analyzing freight transport across Germany — road, rail, and inland waterways.

**The business problem:** Logistics managers had no structured way to compare transport modes across cost, speed, and emissions simultaneously. Manual analysis took hours per corridor decision.

- KPIs tracked: **cost (€/tkm) · transit time (h) · WTW CO₂ intensity (g/tkm)**
- Reduced manual corridor evaluation effort by **~35%** through automated scenario analysis
- 3 scenario models built: **Balanced Incentives · High Carbon Price · Express Rail**
- Finding: no single transport mode dominates all three KPIs — the dashboard makes trade-offs visible and actionable

[![View Project](https://img.shields.io/badge/View_Project-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/AIAnalyticsKureshi/multimodal-freight-decision-intelligence)
...
- Applied data validation and consistency checks to ensure reliability of business information
- Coordinated daily operational activities across departments with full documentation and task tracking
